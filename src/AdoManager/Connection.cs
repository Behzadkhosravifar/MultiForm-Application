...
namespace AdoManager
{
    public class Connection : ICloneable
    {
        ...
        {
            string name = null;
            if (add.Attribute("name") != null) 
                name = add.Attribute("name").Value;

            string publicKeyToken = null;
            if (add.Attribute("publicKeyToken") != null)
                publicKeyToken = add.Attribute("publicKeyToken").Value;

            string description = null;
            if (add.Attribute("description") != null)
                description = add.Attribute("description").Value;

            var connectionString = add.Attribute("connectionString").Value;

            string providerName = null;
            if (add.Attribute("providerName") != null)
                providerName = add.Attribute("providerName").Value;
            ...
            conn.ProviderName = encrypted ? (providerName == null ? null : providerName.Decrypt()) : providerName;
